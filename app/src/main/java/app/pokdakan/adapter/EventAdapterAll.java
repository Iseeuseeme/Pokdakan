...
public class EventAdapterAll extends RecyclerView.Adapter<EventAdapterAll.PendudukHolder> {
    List<EventModel> data;
    Context c;
    AlertDialog.Builder mAlert;
    KLIK klik;
    public EventAdapterAll(Context c, KLIK klik) {
        this.c = c;
        this.klik=klik;
    ...
    public void onBindViewHolder(@NonNull PendudukHolder holder, final int position) {
        ...
        holder.subtitle.setText(data.get(position).getName());
    ...
    public class PendudukHolder extends RecyclerView.ViewHolder{
        TextView title, description, date, subtitle;
